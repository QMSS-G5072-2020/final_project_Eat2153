...
def get_geocen_df(quality = str(), year = str(), area_type = str()):
    ...
    Example
    ---
    geocenpy.get_geocen_df(quality = "20m", year = "2010", area_type= "county").shape
    (3221, 7)
...
def get_state_ids(state_initials = str()):
    ...
    Example
    ---
    geocenpy.get_state_ids("OR").shape
    (1, 6)
...
def get_pop(api_key, year = str(), map = bool()):
    ...
    Example
    ---
    geocenpy.get_pop(api_key = my_api_key, year="2018", map = False)
...
def get_house_est(api_key, year = str(), map = bool()):
    ...
    Example
    ---
    geocenpy.get_house_est(api_key = my_api_key, year="2018", map = False)
...
def get_region_pop(api_key, year = str(), map = bool()):
    ...
    Example
    ---
    geocenpy.get_region_pop(api_key = my_api_key, year="2016", map = False)
...
def get_state_pop(api_key, year = str(), state_fip = str(), map = bool()):
    ...
    Example
    ---
    geocenpy.get_state_pop(api_key = my_api_key, year="2016", state_fip = "15", map = False)
